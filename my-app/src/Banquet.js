...
import pro from "./images/banquet-booking-product.png";
            ...
            <div className="py-5 px-6 lg:px-20 max-w-xl lg:mx-auto">
              <div className="border-l-4 border-blue-600 pl-4">
                <h1 className="text-2xl font-bold text-blue-600">
                  Elunicaa - Banquet Booking Portal
                </h1>
                <p className="mt-2 text-gray-700">
                  The banquet booking portal can be integrated within your
                  existing website to provide an easy to use, reliable calendar
                  of events and allow venue bookings to be made 24/7, updating
                  the banquet availability seamlessly.
                </p>
              </div>
              <div
              ...
              <div className="p-0 max-w-2xl">
                <ul className="list-disc ml-4 lg:grid lg:gap-x-6 lg:gap-y-4 grid-cols-2 gap-x-2 gap-y-1 lg:space-y-0 space-y-3">
                  <li>Online Banquet Availability</li>
                  <li>Notification & Engagement</li>
                  <li>Details of Foods and Services</li>
                  <li>Online Payments</li>
                  <li>Manage Amenities</li>
                  <li>Promo Code Offers</li>
                  <li>White Label</li>
                </ul>
              </div>
