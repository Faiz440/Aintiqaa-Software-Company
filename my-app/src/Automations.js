...
export default function Automations() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.127:8000/insert", {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <Helmet>
        <title>
          Integrations Aintiqaa Technologies | Mobile, Cloud and Web Solutions
          Provider
        </title>
        <meta
        ...
        <meta
          property="og:title"
          content="Integrations Aintiqaa Technologies | Mobile, Cloud and Web Solutions Provider"
        ></meta>
      </Helmet>
      <div className="relative isolate overflow-hidden bg-stone-800 py-16 sm:py-24 lg:py-32">
