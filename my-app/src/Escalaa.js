...
import pro from "./images/escalaa-product.png";
            ...
            <div className="py-5 px-6 lg:px-20 max-w-xl lg:mx-auto">
              <div className="border-l-4 border-blue-600 pl-4">
                <h1 className="text-2xl font-bold text-blue-600">
                  Escalaa Services Center Management System
                </h1>
                <p className="mt-2 text-gray-700">
                  To provide Excellent digital platform for Garages that helps
                  them to manage and reduce the administration Works & time of
                  the Garages or Workshops and growing their business.
                </p>
              </div>
              <div
              ...
              <div className="p-0 max-w-2xl">
                <ul className="list-disc ml-4 lg:grid lg:gap-x-6 lg:gap-y-4 grid-cols-2 gap-x-2 gap-y-1 lg:space-y-0 space-y-3">
                  ...
                  <li>Reporting</li>
                  <li>TAX Compliant</li>
                  <li>Auto Repair Estimation</li>
                  <li>Vehicle Booking and Tracking</li>
                </ul>
              </div>
