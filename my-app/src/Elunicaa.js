...
export default function Elunicaa() {
            ...
            <div className="py-5 px-6 lg:px-20 max-w-xl lg:mx-auto">
              <div className="border-l-4 border-blue-600 pl-4">
                <h1 className="text-2xl font-bold text-blue-600">
                  Elunicaa - Food Order & Delivery Portal
                </h1>
                <p className="mt-2 text-gray-700">
                  For restaurant owners they can efficiently process the food
                  orders and deliver to their valuable customers on time.
                </p>
              </div>
              <div
              ...
              <div className="p-0 max-w-2xl">
                <ul className="list-disc ml-4 lg:grid lg:gap-x-6 lg:gap-y-4 grid-cols-2 gap-x-2 gap-y-1 lg:space-y-0 space-y-3">
                  ...
                  <li>Add to Cart and Favorite</li>
